        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                controller: _nicknameController, maxLength: 10,
                decoration: const InputDecoration(
                  hintText: '앱에서 사용할 이름 (2자 이상)',
                  prefixIcon: Icon(Icons.person_outline, size: 18, color: AppColors.lavender),
                  counterText: '',
                ),
              ),
              ...
              const SizedBox(height: 8),
              TextField(
                controller: _passwordConfirmController, obscureText: _obscurePasswordConfirm,
                decoration: InputDecoration(
                  hintText: '비밀번호를 다시 입력',
                  prefixIcon: const Icon(Icons.lock_outline, size: 18, color: AppColors.lavender),
                  suffixIcon: IconButton(
                    icon: Icon(_obscurePasswordConfirm ? Icons.visibility_off_outlined : Icons.visibility_outlined,
                        size: 18, color: AppColors.textHint),
